...
namespace inesctec_mrdt_hangfa_discovery_q2_driver
{
  ...
  InesctecMrdtHangfaDiscoveryQ2DriverROS1::InesctecMrdtHangfaDiscoveryQ2DriverROS1()
      : nh_priv_("~"), serial_comms_first_fault_(true)
  {
    ...
    pub_mot_enc_ = nh_.advertise<inesctec_mrdt_drivers_interfaces::MotEncArrayROS1>("motors_enc", 10);

    sub_mot_ref_ = nh_.subscribe<inesctec_mrdt_drivers_interfaces::MotRefArrayROS1>(
        "motors_ref", 1,
        &InesctecMrdtHangfaDiscoveryQ2DriverROS1::subMotRef, this);
    ...
    serial_port_timer_ = nh_.createTimer(ros::Duration(1),
                                         boost::bind(&InesctecMrdtHangfaDiscoveryQ2DriverROS1::checkSerialComms, this));
  }
