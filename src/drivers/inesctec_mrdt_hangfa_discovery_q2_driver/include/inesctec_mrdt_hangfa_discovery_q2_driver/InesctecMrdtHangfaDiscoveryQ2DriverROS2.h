...
namespace inesctec_mrdt_hangfa_discovery_q2_driver
{
    ...
    private:
        rclcpp::Publisher<inesctec_mrdt_drivers_interfaces::msg::MotEncArray>::SharedPtr
            pub_mot_enc_;

        rclcpp::Subscription<inesctec_mrdt_drivers_interfaces::msg::MotRefArray>::SharedPtr
            sub_mot_ref_;
