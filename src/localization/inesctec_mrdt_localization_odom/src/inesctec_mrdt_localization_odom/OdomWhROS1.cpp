...
namespace inesctec_mrdt_localization_odom
{
  ...
  OdomWhROS1::OdomWhROS1() : nh_priv_("~")
  {
    ...
    pub_mot_ref_ = nh_.advertise<inesctec_mrdt_drivers_interfaces::MotRefArrayROS1>("motors_ref", 10);

    pub_odom_ = nh_.advertise<nav_msgs::Odometry>("odom", 10);

    sub_mot_enc_ = nh_.subscribe<inesctec_mrdt_drivers_interfaces::MotEncArrayROS1>(
