...
namespace inesctec_mrdt_localization_odom
{
  ...
  OdomWhROS2::OdomWhROS2() : rclcpp::Node("inesctec_mrdt_localization_odom_wh")
  {
    ...
    pub_mot_ref_ = this->create_publisher<inesctec_mrdt_drivers_interfaces::msg::MotRefArray>("motors_ref", 10);

    pub_odom_ = this->create_publisher<nav_msgs::msg::Odometry>("odom", 10);

    sub_mot_enc_ = this->create_subscription<inesctec_mrdt_drivers_interfaces::msg::MotEncArray>(
        "motors_enc", 10,
  ...
  void OdomWhROS2::readParam()
  {
    ...
    if (!this->has_parameter("steering_geometry"))
    {
      throw std::runtime_error(
          ...
          "the node inesctec_mrdt_localization_odom requires the definition of the "
    ...
    if (steering_geometry_ == kOdomWhOmni4Str)
    {
          ...
          !this->has_parameter("wh_back_right_inv"))
      {
        throw std::runtime_error(
            ...
            steering_geometry_ + " requires the "
