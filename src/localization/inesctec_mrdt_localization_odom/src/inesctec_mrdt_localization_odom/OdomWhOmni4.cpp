...
namespace inesctec_mrdt_localization_odom
{
    ...
    {
        v = (v_mot[kWhIdxFL] - v_mot[kWhIdxFR] + v_mot[kWhIdxBL] - v_mot[kWhIdxBR]) / 4.0;
        vn = (-v_mot[kWhIdxFL] - v_mot[kWhIdxFR] + v_mot[kWhIdxBL] + v_mot[kWhIdxBR]) / 4.0;
        w = -(v_mot[kWhIdxFL] + v_mot[kWhIdxFR] + v_mot[kWhIdxBL] + v_mot[kWhIdxBR]) / (2 * (rob_l[kRobLenIdxF2B] + rob_l[kRobLenIdxL2R]));
    }
