...
#include "inesctec_mrdt_localization_odom/utils.h"
...
class OdomWh
{
 ...
 public:
  ...
  inline size_t getMotorDriveIdx(const size_t &idx) { return mot_idx[idx]; }
  ...
  virtual void computeFwdKin(const std::vector<double> &v_mot, double &v,
                             double &vn, double &w) = 0;
