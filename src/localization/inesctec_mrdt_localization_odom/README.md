...
```sh
roslaunch inesctec_mrdt_localization_odom inesctec_mrdt_localization_odom_wh.launch
```

**ROS 2**

```sh
ros2 launch inesctec_mrdt_localization_odom inesctec_mrdt_localization_odom_wh.launch.xml
```
